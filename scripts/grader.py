...
def graderMain(executablePath, gradingCSV):
    os.makedirs("../output/grader_out", exist_ok=True)
    ...
    for aPlanner in [0, 1, 2, 3]:
        ...
        for i, data in enumerate(problems):
            ...
            commandVerify = "./../build/verifier {} {} {} {} {}".format(
                "../maps/" + inputMap, numDOFs, startPos, goalPos,
                outputSolutionFile)
    ...
    with open(gradingCSV, "w", newline="") as f:
        writer = csv.writer(f)
        writer.writerow(["planner", "mapName", "problemIndex", "numSteps", "cost", "timespent", "success"])
